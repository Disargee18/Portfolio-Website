import image from "../assets/opaw.jpg"
    ...
    return (
        <>
            <div className="aboutMe">
                <h1 className="text-4xl font-bold">Hey, this is Argee👋</h1>
                <h3 className="text-2xl font-thin text-gray-400 mt-4" >Web Developer</h3>
                ...
                <div>
                    <h1 className="text-xl font-bold py-3">About</h1>
